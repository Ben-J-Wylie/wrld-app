...
const styles = StyleSheet.create({
  ...
  title: { ...theme.typography.body, color: theme.colors.text.primary, fontWeight: '600' },
  ...
  viewers: { ...theme.typography.caption, color: theme.colors.text.muted },
  distance: { ...theme.typography.caption, color: theme.colors.text.muted, flexShrink: 0 },
})
